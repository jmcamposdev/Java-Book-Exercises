...
import unit12.Actividad11.OrdenarSocioAntiguedad;
...
public class Actividad22 {
    ...
    private static final int OPCION_LISTADO_NOMBRE = 6;
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            mostrarMenu();
            userOption = GetData.getInt("Ingrese una opción (1 - 7): ", 1, 7);
            switch (userOption) {
                ...
                case OPCION_LISTADO_ANTIGUEDAD -> {
                    listaSocios.sort(new OrdenarSocioAntiguedad());
                    listarSocios();
                    Collections.sort(listaSocios);
                }
                case OPCION_LISTADO_NOMBRE -> {
                    listaSocios.sort(new OrdenarSocioNombre());
                    listarSocios();
                    Collections.sort(listaSocios);
                }
