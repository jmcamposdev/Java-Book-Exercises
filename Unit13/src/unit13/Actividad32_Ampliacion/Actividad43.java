package unit13.Actividad32_Ampliacion;


import unit13.Actividad30_Ampliacion.Socio;
...
/*
    Repite la Actividad pero sustituye todos los listaos por streams
...
public class Actividad43 {
    ...
    private static void mostrar (Map<Integer, Jugador> plantilla) {
        plantilla.forEach((key, value) -> System.out.println(key + ". " + value.getNombre()));
        System.out.println("--------------------");
    }
